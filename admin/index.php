...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/sjec1.jpg);">

		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3">.
					<div class="login-panel panel panel-default mt-3x">
							<div class="panel-heading"style="background-color: rgba(245, 245, 245, 0);">
								<div class="row">
									<div class="col-md-2">
                          			 	<a href="#" target="_self"><img src="img/sj1.png" alt="Logo"></a>
                        			</div>
                        			<div class="row justify-content-center">
                            			<h2 class="text-left text-bold text-dark"> Hostel Management System</h2>
                        			</div>
								</div>
							</div>
						<div class="well row pt-1x pb-2x">
